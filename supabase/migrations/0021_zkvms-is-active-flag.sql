...
ALTER TABLE "zkvms" ADD COLUMN "dual_license" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "zkvms" ADD COLUMN "is_active" boolean DEFAULT false NOT NULL;--> statement-breakpoint
