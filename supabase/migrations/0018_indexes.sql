...
CREATE INDEX "proofs_cluster_version_id_idx" ON "proofs" USING btree ("cluster_version_id");--> statement-breakpoint
CREATE INDEX "proofs_proved_timestamp_idx" ON "proofs" USING btree ("proved_timestamp");--> statement-breakpoint
CREATE INDEX "proofs_created_at_idx" ON "proofs" USING btree ("created_at");