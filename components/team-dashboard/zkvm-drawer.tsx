...
export function ZkvmDrawer({
  ...
  const [slug, setSlug] = useState(zkvm?.slug || "")
        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col px-4">
          <div className="flex-1 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="isa">instruction set architecture (ISA)</Label>
                <Input
                  id="isa"
                  name="isa"
                  type="text"
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  v1.0.0
                  {latestVersion && ` — current: v${latestVersion.version}`}
                </p>
              </div>
            ...
            <Accordion type="multiple" className="w-full">
              <AccordionItem value="security-metrics" className="border-none">
                ...
                <AccordionContent className="space-y-4 pt-2">
                  <div className="space-y-2">
                    <Label htmlFor="implementation_soundness">
