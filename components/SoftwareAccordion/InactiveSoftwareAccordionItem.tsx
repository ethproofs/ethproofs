  ...
  return (
    <AccordionItem value={value} className="col-span-8 grid grid-cols-subgrid">
      <div className="col-span-8 grid grid-cols-subgrid items-center justify-items-center gap-12 text-nowrap border-b p-px px-6">
        ...
        <div id="is-open-source" className="col-start-3">
          {zkvm.dual_license ? <Check className="text-primary" /> : null}
        </div>
        <div id="is-open-source" className="col-start-4">
        ...
        <AccordionTrigger
          disabled
          className="col-start-5 my-4 h-fit gap-2 rounded-full border-2 bg-background-highlight p-0.5 pe-2 text-4xl text-border [&>svg]:size-6"
        >
