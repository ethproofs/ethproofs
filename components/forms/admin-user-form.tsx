  ...
  return (
    <form className="flex flex-col gap-4" action={formAction}>
      ...
      <div className="position-relative display-inline-block flex flex-col gap-2">
        <span className="text-sm font-normal">logo (optional)</span>
        <Label
          htmlFor="logo"
          className="h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm font-normal text-muted-foreground ring-offset-background"
        >
          choose file
        </Label>
        <Input
