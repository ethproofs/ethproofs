...
const cohortScores: CohortScore[] = [
  {
    ...
    abbreviation: "PS",
    formula: "(sub-2m proofs / total blocks) x 100",
    target: `>${OPP_PERFORMANCE_SCORE_THRESHOLD}%`,
    isMinimize: false,
  },
  {
    name: "liveness score",
    ...
    target: `>${OPP_LIVENESS_SCORE_THRESHOLD}%`,
    isMinimize: false,
  },
  {
    name: "stunner rate",
    abbreviation: "SR",
    formula: "(>2m proofs / total blocks) x 100",
    target: "minimize",
    isMinimize: true,
  },
  {
...
export function OppCohortScoresContent() {
  return (
    <Table>
      <TableHeader>
        <TableRow>
...
export function OppCohortScores() {
  return (
    <Card className="flex h-full flex-col">
      <CardHeader>
        <CardTitle className="text-lg">1:10 cohort scores</CardTitle>
      </CardHeader>
