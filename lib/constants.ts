...
export const RTP_PERFORMANCE_SCORE_THRESHOLD = 70
...
export const OPP_BLOCK_SAMPLING_INTERVAL = 10

export const SECURITY_MILESTONE_THRESHOLDS = {
  M1_SOUNDCALC: true,
  M2A_SECURITY_BITS: 100,
  M2B_PROOF_SIZE_BYTES: 600 * 1024,
  M3A_SECURITY_BITS: 128,
  M3B_PROOF_SIZE_BYTES: 300 * 1024,
} as const
